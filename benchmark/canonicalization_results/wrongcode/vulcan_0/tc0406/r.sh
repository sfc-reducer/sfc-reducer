...
if 
  ...
  ! grep 'comparison between pointer and integer' outa.txt &&\
   timeout -s 9 60 /uusoc/exports/scratch/chenyang/compilers/compiler-install/gcc-430/bin/gcc-430 -Os  -w -DINLINE= -DCSMITH_MINIMAL  -I/uusoc/exports/scratch/chenyang/csmith/runtime  -DWRAP_VOLATILES=0   small.c -o small1 > cc_out1.txt 2>&1 &&\
  ...
  RunSafely.sh 27 1 /dev/null out_framac.txt frama-c -cpp-command \"gcc -C -Dvolatile= -E -I.\" -val-signed-overflow-alarms -val-stop-at-first-alarm -no-val-show-progress -machdep x86_64 -obviously-terminates -precise-unions small-framac.c &&\
