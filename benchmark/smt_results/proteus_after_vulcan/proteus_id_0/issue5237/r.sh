...
/tmp/benchmark/smt_benchmarks/stuff/match_err.py 2 "m->hasApproximations" /tmp/benchmark/smt_benchmarks/bin/cvc4-e6c9674 --check-models --lang smt2 $* < issue5237.smt2
RET=$?
if [ $RET -eq 0 ]; then
    exit 1
elif [ $RET -eq 1 ]; then
