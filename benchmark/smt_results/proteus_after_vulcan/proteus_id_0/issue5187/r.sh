...
/tmp/benchmark/smt_benchmarks/stuff/match_err.py 2 "d_decisionEngine->hasSatLiteral" /tmp/benchmark/smt_benchmarks/bin/cvc4-13cf418 --strings-exp -i --lang smt2 $* < issue5187.smt2
RET=$?
if [ $RET -eq 0 ]; then
    exit 1
elif [ $RET -eq 1 ]; then
