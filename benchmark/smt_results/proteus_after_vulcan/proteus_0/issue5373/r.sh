...
/tmp/benchmark/smt_benchmarks/stuff/match_err.py 2 "Literal not in the CNF Cache" /tmp/benchmark/smt_benchmarks/bin/cvc4-42fe4ae -i --lang smt2 $* < issue5373.smt2
RET=$?
if [ $RET -eq 0 ]; then
    exit 1
elif [ $RET -eq 1 ]; then
