...
/tmp/benchmark/smt_benchmarks/stuff/match_err.py 2 "BVToInt::translateWithChildren" /tmp/benchmark/smt_benchmarks/bin/cvc4-e591346 --lang smt2 $* < issue5230-3.smt2
RET=$?
if [ $RET -eq 0 ]; then
    exit 1
elif [ $RET -eq 1 ]; then
