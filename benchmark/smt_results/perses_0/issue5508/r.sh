...
/tmp/benchmark/smt_benchmarks/stuff/match_err.py 2 "d_state.isInConflict" /tmp/benchmark/smt_benchmarks/bin/cvc4-36af095 --strings-exp --lang smt2 $* < issue5508.smt2
RET=$?
if [ $RET -eq 0 ]; then
    exit 1
elif [ $RET -eq 1 ]; then
