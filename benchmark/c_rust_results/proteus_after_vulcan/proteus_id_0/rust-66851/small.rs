    ...
    fn specials(to : i32,
        ...
        while lo_val<vmax{
            ...
            if res {
                ...
                for usize in 1..ix+2 {
                    new_max_min[to!{usize,usize}][0]=
                                                         lo_val+max_min[to!{usize,usize}-1][0] ;
                    new_max_min[to!{usize,usize}][1]=max_min[to!{usize,usize}][1]
                                                    .max(lo_val+new_max_min[to!{usize,usize}-1][1]);
                }
                let res = specials(vmax  ,
                                   &    new_max_min,
                                   vmax            ,
                                   lo_val,
                                   ix + 1,
